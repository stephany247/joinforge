...
function Hero() {
  return (
    <section className="px-6 flex flex-col items-center justify-center md:items-start gap-8 sm:gap-4">
      <h2 className="text-sm md:text-2xl font-light text-center md:text-left md:-mb-16">
      ...
      <RadialGlow className="top-1/3 sm:top-1/5 md:-right-8" />
